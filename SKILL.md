...
- Skill 이름, 기능명, Notion 상태값, 브랜치명, 코드 식별자, 설정 키, 명령어는 영어 원문을 유지합니다. Notion 속성명은 사용자가 읽기 쉬운 한글을 사용합니다.
...
- 새 직무는 `상태`가 Candidate인 항목으로 저장합니다. 사용자가 승인하기 전에는 Trend Update에 사용하지 않습니다.
